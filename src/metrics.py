...
class BB84Metrics:
    ...
    def calculate_final_key_length(self, sifted_key_length, sampled_bits):
        """
        Calculate final key length after error detection and sample discard.
        
        This removes the publicly disclosed sample bits from the sifted key.
        
        Note: True privacy amplification (entropy-based compression using
        universal hashing) is not implemented in this simulation.
